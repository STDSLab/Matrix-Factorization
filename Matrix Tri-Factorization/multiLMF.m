function [bestRunRes, runRes] = multiLMF(nmRuns, cores, X, errMthd, args, stopVal)
%multiLMF Runs LMF multiple times and returns all runs and the best run (least error)
%   Input:
...
%      args - the arguments for the method implementation, see LMF
%      stopVal - stop value for method implementation, may be unused
%       depending on implementation, see LMF
%
%   Output:
        ...
        for iRuns = 1:nmRuns
            [runRes{iRuns}.F, runRes{iRuns}.S, ...
             ...
             runRes{iRuns}.runStats] = ...
                LMF(X, args.k, args.lnModeStr, args.params, ...
