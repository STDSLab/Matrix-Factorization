function [bestRunRes, runRes] = multiFastMtF(nmRuns, cores, X, errMthd, args, stopVal)
%multiFastMtF Runs FastMtF multiple times and returns all runs and the best run (least error)
%   Input:
...
%      args - the arguments for the method implementation, see fastMtF
%      stopVal - stop value for method implementation, may be unused
%       depending on implementation, see fastMtF
%
%   Output:
        ...
        for iRuns = 1:nmRuns
            [runRes{iRuns}.F, runRes{iRuns}.S, ...
             ...
             runRes{iRuns}.runStats] = ...
                fastMtF(X, args.k, args.lnModeStr, args.params, ...
